            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-orange focus:border-transparent pr-12"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-secondary-mediumGray">Remember me</span>
                </label>
                <a href="#" className="text-sm text-primary-orange hover:text-orange-600">
                  Forgot password?
                </a>
              </div>
              ...
              <Link
                to="/dashboard"
                className="w-full bg-primary-orange text-white py-3 rounded-lg font-semibold hover:bg-orange-600 transition-colors text-center block"
              >
                Sign In
              </Link>
            </form>
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-secondary-white text-secondary-mediumGray">Or continue with</span>
                </div>
              </div>
